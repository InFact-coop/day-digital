    ...
    section [ class "bg-light-blue m0-auto cover" ]
        ...
        , section [ class "w-50-l w-90 w-75-m center bg-white br3 shadow-1 pv3" ]
            [ article [ class " w-90 center pv1" ]
                [ div []
                    [ div [ class "mid-gray b bb b--light-gray f3 f3" ] [ text "About you" ]
            ...
            , article [ class " w-90 center pv1" ]
                [ div []
                    [ div [ class "mid-gray b bb b--light-gray f3" ] [ text "What kind of job are you looking for?" ]
            ...
            , article [ class " w-90 center pv1" ]
                [ div []
                    [ div [ class "mid-gray b bb b--light-gray f3 " ] [ text "Link to your CV" ]
                    , div [ class "open-sans black fw4 flex justify-between flex-wrap f6" ]
                        [ div [ class "w-50-ns w-100 pv3 flex-column bg-none" ]
            ...
            , article [ class " w-90 center pv1" ]
                [ div []
                    [ div [ class "mid-gray b bb b--light-gray f3" ] [ text "Add links to your social media accounts" ]
                    , div [ class "open-sans black fw4 flex justify-between flex-wrap f6" ]
                        [ div [ class "w-50-ns w-100 pv3 flex-column bg-none" ]
                            [ text "LinkedIn"
        ...
        , a
            [ href "", class "center tc no-underline fw1" ]
            [ div [ class "white w-20-l w-40-m w-60 bg-gray fw2 center mv5 pa3 br4 fw1 f5 no-underline open-sans" ] [ text "Next" ]
            ]
        ]
